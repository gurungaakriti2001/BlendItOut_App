...
const VOWELS = [
  { vowel: 'A', color: '#ff3b30', word: 'APPLE',    image: `${B}/images/cvc/vowelfunimages/apple_nobg.png`, vowelSound: `${B}/audio/vowel-fun/a.mp3`, wordSound: `${B}/audio/vowel-words/a-apple.mp3` },
  { vowel: 'E', color: '#34c759', word: 'ELEPHANT', image: `${B}/images/cvc/vowelfunimages/elephant_nobg.png`, vowelSound: `${B}/audio/vowel-fun/e.mp3`, wordSound: `${B}/audio/vowel-words/e-elephant.mp3` },
  { vowel: 'I', color: '#58ccfb', word: 'INSECT',   image: `${B}/images/cvc/vowelfunimages/insect_nobg.png`, vowelSound: `${B}/audio/vowel-fun/i.mp3`, wordSound: `${B}/audio/vowel-words/i-insect.mp3` },
  { vowel: 'O', color: '#ff9500', word: 'OCTOPUS',  image: `${B}/images/cvc/vowelfunimages/octopus_nobg.png`, vowelSound: `${B}/audio/vowel-fun/o.mp3`, wordSound: `${B}/audio/vowel-words/o-octopus.mp3` },
  { vowel: 'U', color: '#af52de', word: 'UP',       image: `${B}/images/cvc/vowelfunimages/up_nobg.png`, vowelSound: `${B}/audio/vowel-fun/u.mp3`, wordSound: `${B}/audio/vowel-words/u-up.mp3` },
];
