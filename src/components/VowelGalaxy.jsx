...
const VOWELS = [
  ...
  { vowel: 'O', color: '#ff9500', word: 'OCTOPUS',  image: `${B}/images/cvc/vowelfunimages/octopus.jpg`, vowelSound: `${B}/audio/vowel-fun/o.mp3`, wordSound: `${B}/audio/vowel-words/o-octopus.mp3` },
